...
def main():
    ...
    parser.add_argument(
        "--version",
        type=str,
        default=os.environ.get("VERSION", "1.21.11"),
        help='Minecraft Version (Default: environment variable VERSION or "1.21.11")',
    )

    parser.add_argument(
        "--build",
        type=str,
        default=os.environ.get("BUILD", "2"),
        help='Build Number (Default: environment variable BUILD or "2")',
    )

    parser.add_argument(
        "--channel",
        type=str,
        default=os.environ.get("CHANNEL", "experimental"),
        choices=["default", "experimental"],
        help='Release channel (Default: environment variable CHANNEL or "experimental")',
    )
